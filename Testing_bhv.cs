...
public class Testing_bhv : MonoBehaviour
{
    // gameobject
    ...
    IEnumerator SceneSetting()
    {
        ...
        yield return new WaitForSeconds(4f);  // Wait for fixation period
    ...
    void SetPlayerPos(GameObject playerObject, float minDistance = 3f)
    {
        ...
        while (attempts < maxAttempts)
        {
            ...
            // Check distance from context_target[0,0] and context_target[1,0]
