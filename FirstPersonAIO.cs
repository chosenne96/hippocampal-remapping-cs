...
public class BETA_SETTINGS{
    ...
    private void Update()
    {
        rightPressed = Input.GetKey(SbjManager.rightKey);
        leftPressed = Input.GetKey(SbjManager.leftKey);
    ...
    private void FixedUpdate()
    {
            ...
            mouseXInput = 0;
            mouseYInput = 0.25f * System.Convert.ToSingle(rightPressed) -
                          0.25f * System.Convert.ToSingle(leftPressed);
            if (!playerCanMove)
                mouseYInput = 0;
    ...
    if(advanced.maxSlopeAngle>0){
        ...
        verticalInput =  System.Convert.ToSingle(Input.GetKey(SbjManager.forwardKey)); //fMRI
        inputXY = new Vector2(0f, verticalInput);
