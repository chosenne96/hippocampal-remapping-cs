...
//         RemapManager.fmriWriter.WriteLine($"fix_end" + "\t" + RemapManager.fmriTimer.ToString());
//         RemapManager.fmriWriter.WriteLine($"scene_started" + "\t" + RemapManager.fmriTimer.ToString());
        
//         // Rotate player 180 degrees away from coin
...
//             RemapManager.fmriWriter.WriteLine($"Coin_found" + "\t" + RemapManager.fmriTimer.ToString());
//             // log file
